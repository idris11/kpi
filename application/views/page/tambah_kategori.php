...
<section class="content-header">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
			    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>kategori/proses_tambah_kategori">
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-3 control-label">Kode Kategori</label>
              <div class="col-sm-5">
