...
<section class="content-header">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
			    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>jabatan/proses_tambah_jabatan">
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-3 control-label">Kode Jabatan</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" placeholder="Kode Jabatan" name="kd_jabatan">
              </div>
            </div>
            <div class="form-group">
